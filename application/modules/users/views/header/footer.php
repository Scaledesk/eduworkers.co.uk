        ...
        <div class="row">
          <div class="col-lg-3 col-sm-3">
            <section class="footer-section">
              <h3 class="footer-title">EDUWORKERS</h3>
              <!-- <a href="javascript:void(0);"><img class="footer-logo img-responsive" src="<?php echo  asset_url();?>\img\final_logo.jpg" height="80" width="150" alt="Logo"></a> -->
              <!-- <div class="footer-info">“Eduworkers” is a pioneer in the realm of Innovative Academic Writing. Since the inception

the company in 2009, we have <a href="#">READ MORE</a> </div> -->
          ...
          <div class="col-lg-2 col-sm-3">
            <section class="footer-section">
              ...
              <ul class="footer-list list-unstyled">
                <li class="footer-list__item"><a class="footer-list__link" href="javascript:void(0);">Engineering Assignments</a></li>
                <li class="footer-list__item"><a class="footer-list__link" href="javascript:void(0);">Engineering Projects</a></li>
                <li class="footer-list__item"><a class="footer-list__link" href="javascript:void(0);">Essay Writing</a></li>
                <li class="footer-list__item"><a class="footer-list__link" href="javascript:void(0);">DIssertation Writing</a></li>
  ...
  <script src="<?php echo  asset_url();?>js/modernizr.custom.js"></script>
  <script src="<?php echo  asset_url();?>js/waypoints.min.js"></script>
  <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>

  <!--THEME-->
  <script src="<?php echo  asset_url();?>plugins/sliderpro/js/jquery.sliderPro.min.js"></script>
  <script src="<?php echo  asset_url();?>plugins/owl-carousel/owl.carousel.min.js"></script>
  <script src="<?php echo  asset_url();?>plugins/isotope/jquery.isotope.min.js"></script>
  <script src="<?php echo  asset_url();?>plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>
  <script src="<?php echo  asset_url();?>plugins/datetimepicker/jquery.datetimepicker.js"></script>
  <script src="<?php echo  asset_url();?>plugins/jelect/jquery.jelect.js"></script>
  <script src="<?php echo  asset_url();?>plugins/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
