...
class Users extends MX_Controller{
    ...
    function __construct()
    {
        ...
        parent::__construct();
        require $_SERVER["DOCUMENT_ROOT"].'/eduworkers.co.uk/vendor/autoload.php';
...
public function login()
    ...
    private function _facebookAppConf(){
        $fb = new Facebook\Facebook([
            'app_id' => '506088969572259',
            'app_secret' => '2426a12f1f0ae2480ee1c20139ab68c2',
...
//$tokenMetadata->validateUserId('123');
    ...
    public function doGoogleLogin(){
        ...
        $db_name = 'eduworkers'; //Database Name
        ###################################################################
        $gClient = new Google_Client();
        $gClient->setApplicationName('Eduworkers');
